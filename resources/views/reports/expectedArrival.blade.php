...
@section('content')
    ...
    <tr height="50">
        <td class="s5">#</td>
        <td colspan="2" class="s5">Resv. #</td>
        <td colspan="2" class="s5">Room #</td>
        <td class="s6">Title</td>
        <td colspan="2" class="s6">Full Name</td>
        <td class="s7">Deposit</td>
        <td colspan="3" class="s5">Arrival</td>
        <td class="s5">Departure</td>
        <td colspan="3" class="s6">Room Type</td>
        <td colspan="2" class="s6">Rate Type</td>
        <td class="s5">A</td>
        <td class="s5">C</td>
    ...
    <tbody>
        ...
        @foreach ($data['data'] as $item)
            <tr style="height:19px">
                ...
                <td class="s10">{{ number_format($item->Deposit) }}</td>
                <td colspan="3" class="s11">{{ $item->DateArrival }}</td>
                <td class="s11">{{ $item->DateDeparture }}</td>
                <td colspan="3" class="s9">{{ $item->RoomType }}</td>
                <td colspan="2" class="s9">{{ $item->RateType}}</td>
                <td class="s8">{{ $item->Adult }}</td>
                <td class="s8">{{ $item->Child }}</td>
