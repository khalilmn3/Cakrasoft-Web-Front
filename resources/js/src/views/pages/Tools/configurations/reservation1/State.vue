            ...
            <div v-else>
                <vs-row vs-align="center" vs-type="flex" vs-justify="flex-start" class="mb-3" vs-w="12">
                    ...
                    <vs-col vs-lg="5" class="w-full">
                        <vs-input :maxLength="2" v-bind:disabled="(modeDataValue == global.modeData.edit)" @input="val => vModel.code = val.toUpperCase()" class="w-full" type="text" v-model="vModel.code" :description-text="errors.first('code') || dbErrors.code | toString" v-validate="'required'" name="code" />
                    </vs-col>
                </vs-row>
                <vs-row vs-align="center" vs-type="flex" vs-justify="flex-start" class="mb-3" vs-w="12">
                    <vs-col vs-lg="3" class="w-full">
                 ...
                 <vs-row vs-align="center" vs-type="flex" vs-justify="flex-start" class="mb-3" vs-w="12">
                    ...
                    <vs-col vs-lg="9" class="wrap-form-select w-full">
                        <v-select id="form-select" :reduce="value => value.code" label="name" class="w-full" :options="countries" v-model="vModel.country_code"></v-select>
                    </vs-col>
                </vs-row>
            </div>
            </template>
...
export default {
    ...
    data() {
        return {
            ...
            searchFilterData: [
                ...
                { text: this.$t('common.filter.country'), value: '2' },
    ...
    beforeMount() {
        ...
        this.columnDefs = [
            ...
            { headerName: this.$t('common.table.country'), field: 'country', width: 150 },
