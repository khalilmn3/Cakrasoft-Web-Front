        ...
        <dialog-prompt :button1="modeDataValue !== global.modeData.tracking"
            ...
            <template #body>
                ...
                <div v-else>
                     ...
                     <vs-row vs-align="center" vs-type="flex" vs-justify="flex-start" class="mb-3" vs-w="12">
                        <vs-col class="sm:w-1/6 w-full">
                            <span>{{ $t('common.table.idSort') }}</span>
                        </vs-col>
                        <vs-col>
                            <vs-input-number name="id_sort" v-model.number="vModel.id_sort" :label="$t('common.table.idSort')" icon-inc="expand_less" icon-dec="expand_more"/>
                        </vs-col>
                    </vs-row>
                </div>
            </template>
...
export default {
    ...
    data() {
        return {
            ...
            searchFilterData: [
                { text: this.$t('common.code'), value: '0' },
                { text: this.$t('common.name'), value: '1' },
                { text: this.$t('common.lastUpdate'), value: '2' },
            ],
            // query data search
            limitPageSize: 0,
            search: {
