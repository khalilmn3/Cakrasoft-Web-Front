                ...
                <div v-else>
                    ...
                    <vs-row vs-align="center" vs-type="flex" vs-justify="flex-start" class="mb-3" vs-w="12">
                        <vs-col class="sm:w-1/6 w-full">
                            ...
                            <vs-input class="w-full" type="text" v-model="vModel.description" :description-text="errors.first('description') || dbErrors.description | toString" v-validate="'required'" name="description"/>
                            </vs-col>
                    </vs-row>
                    <vs-row vs-align="center" vs-type="flex" vs-justify="flex-start" class="mb-3" vs-w="12">
                        <vs-col class="sm:w-1/6 w-full">
...
export default {
    ...
    data() {
        return {
            ...
            searchFilterData: [
                ...
                { text: this.$t('common.filter.description'), value: '1' },
    ...
    beforeMount() {
        ...
        this.columnDefs = [
            ...
            { headerName: this.$t('common.table.description'), field: 'description', width: 350 },
