                 ...
                 <vs-row vs-align="center" vs-type="flex" vs-justify="flex-start" class="mb-3" vs-w="12">
                   ...
                   <vs-row vs-align="center" vs-type="flex" vs-justify="flex-start" class="mb-3" vs-w="12">
                    ...
                    <vs-col vs-lg="9" class="wrap-form-select w-full">
                        <v-select id="form-select" :reduce="value => value.code" label="name" class="w-full" :options="categories" v-model="vModel.category_code"></v-select>
                    </vs-col>
                </vs-row>
            </div>
            </template>
...
export default {
    ...
    data() {
        return {
            ...
            searchFilterData: [
                { text: this.$t('common.fitler.code'), value: '0' },
                { text: this.$t('common.fitler.name'), value: '1' },
                { text: this.$t('common.fitler.category'), value: '2' },
                { text: this.$t('common.fitler.lastUpdate'), value: '3' },
            ],
            // query data search
            limitPageSize: 0,
            search: {
    ...
    beforeMount() {
        ...
        this.columnDefs = [
            ...
            { headerName: this.$t('common.table.name'), field: 'name', width: 150 },
