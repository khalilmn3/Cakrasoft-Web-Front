            ...
            <template #body>
                ...
                <div v-else>
                     <vs-row vs-align="center" vs-type="flex" vs-justify="flex-start" class="mb-3" vs-w="12">
                        ...
                        <vs-col vs-lg="5" class="wrap-form-select w-full">
                            <v-select id="form-select" v-bind:disabled="(modeDataValue == global.modeData.edit)" @input="vModel.name = vModel.code.name" label="code" class="w-full" :options="codes" v-model="vModel.code" v-validate="'required'" name="code">
                                <template slot="option" slot-scope="option">
                                    {{ option.code }} | {{ option.name }}
                                </template>
                            </v-select>
                            <span class="error-text text-danger" v-show="errors.has('code')">{{ errors.first('code') || dbErrors.code | toString}}</span>
                        </vs-col>
                    </vs-row>
                    <vs-row vs-align="center" vs-type="flex" vs-justify="flex-start" class="mb-3" vs-w="12">
                        <vs-col vs-lg="3" class="w-full">
                        ...
                        <vs-col vs-lg="9" class="w-full">
                            <vs-input :maxLength="100"  class="w-full" type="text" v-model="vModel.name" :description-text="errors.first('name') || dbErrors.name | toString" v-validate="'required'" name="name" />
                        </vs-col>
                    </vs-row>
                    <vs-row vs-align="center" vs-type="flex" vs-justify="flex-start" class="mb-3" vs-w="12">
                        <vs-col vs-lg="3" class="w-full">
                        ...
                        <vs-col vs-lg="9" class="w-full vs-input">
                            <vs-textarea class="w-full" type="text" v-model="vModel.description" />
                        </vs-col>
                    </vs-row>
                    <vs-row class="mt-3" vs-w="12" vs-type="flex" vs-justify="center">
                        ...
                        <vs-col vs-lg="9" class="w-full vs-input">
                            <div class="text-center image-container-64">
                                <img v-if="imageUrl" class="image-content-64" :src="imageUrl" />
                                <span onclick="document.getElementById('image-upload').click()" v-if="!imageUrl" class="upload-text" ><vs-icon icon-pack="feather" icon="icon-plus"></vs-icon></span>
...
export default {
    ...
    data() {
        return {
            ...
            searchFilterData: [
                ...
                { text: this.$t('common.filter.description'), value: '2' },
    ...
    beforeMount() {
        ...
        this.columnDefs = [
            ...
            { headerName: this.$t('common.table.description'), field: 'description', width: 300 },
    ...
    methods: {
        ...
        updateData(data) {
            ...
            request
                .post(`${this.routeApi}/${this.idData.code}`, data)
                .then(() => {
