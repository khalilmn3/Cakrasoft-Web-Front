                ...
                <div v-else>
                     <vs-row vs-align="center" vs-type="flex" vs-justify="flex-start" class="mb-3" vs-w="12">
                        ...
                        <vs-col class="sm:w-2/5 w-full">
                            <vs-input :maxLength="4" v-bind:disabled="(modeDataValue == global.modeData.edit)" class="w-full" type="text" v-model="vModel.code" :description-text="errors.first('code') || dbErrors.code | toString" v-validate="'required'" name="code" />
                        </vs-col>
                    </vs-row>
                     <vs-row vs-align="center" vs-type="flex" vs-justify="flex-start" class="mb-3" vs-w="12">
                        <vs-col class="sm:w-1/6 w-full">
...
import { countDecimals } from '@/utils/format.js';
...
export default {
    ...
    beforeMount() {
        ...
        this.columnDefs = [
            ...
            { headerName: this.$t('common.table.lastUpdate'), field: 'user_id', width: 210 },
        ];
        ...
        refreshData(search) {
            ...
            request
                ...
                .then((result) => {
                    ...
                    setTimeout(() => {
                        this.rowSelectedAfterRefresh(this, selectedNodes, 'id_log');
                    }, 100);
                }).catch(() => {
    ...
    computed: {
        ...
        currencyFormat() { return this.$store.state.configurations.currencyFormat; },
    },
