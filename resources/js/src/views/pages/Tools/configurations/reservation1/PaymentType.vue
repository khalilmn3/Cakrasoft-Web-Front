                ...
                <div v-else>
                    ...
                    <vs-row vs-align="center" vs-type="flex" vs-justify="flex-start" class="mb-3" vs-w="12">
                        ...
                        <vs-col vs-lg="9" class="wrap-form-select w-full">
                            <v-select id="form-select" :reduce="value => value.code" label="name" class="w-full" :options="groups" v-model="vModel.group_code" v-validate="'required'" name="group"></v-select>
                            <span class="error-text text-danger" v-show="errors.has('group')">{{ errors.first('group') }}</span>
                        </vs-col>
                    </vs-row>
                    <vs-row vs-align="center" vs-type="flex" vs-justify="flex-start" class="mb-3" vs-w="12">
                        <vs-col vs-lg="3" class="w-full">
...
export default {
    ...
    beforeMount() {
        ...
        this.columnDefs = [
            ...
            { headerName: this.$t('common.table.group'), field: 'group', width: 150 },
