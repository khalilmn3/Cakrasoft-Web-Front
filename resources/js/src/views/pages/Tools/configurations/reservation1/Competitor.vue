                ...
                <div v-else>
                    <vs-row vs-align="center" vs-type="flex" vs-justify="flex-start" class="mb-3" vs-w="12">
                        ...
                        <vs-col vs-lg="5" class="w-full">
                            <vs-input :maxLength="20" v-bind:disabled="(modeDataValue == global.modeData.edit)" @input="val => vModel.code = val.toUpperCase()" class="w-full" type="text" v-model="vModel.code" :description-text="errors.first('code') || dbErrors.code | toString" v-validate="'required'" name="code" />
                        </vs-col>
                    </vs-row>
                    <vs-row vs-align="center" vs-type="flex" vs-justify="flex-start" class="mb-3" vs-w="12">
                        <vs-col vs-lg="3" class="w-full">
                        ...
                        <vs-col vs-lg="9" class="w-full">
                            <vs-input class="w-full" type="text" v-model="vModel.name" :description-text="errors.first('name') || dbErrors.name | toString" v-validate="'required'" name="name" />
                        </vs-col>
                    </vs-row>
                     <vs-row vs-align="center" vs-type="flex" vs-justify="flex-start" class="mb-3" vs-w="12">
                        <vs-col vs-lg="3" class="w-full">
                        ...
                        <vs-col vs-lg="9" class="wrap-form-select w-full">
                            <v-select id="form-select" :reduce="value => value.code" label="name" class="w-full" :options="categories" v-model="vModel.category_code" v-validate="'required'" name="category"></v-select>
                            <span class="error-text text-danger" v-show="errors.has('category')">{{ errors.first('category') }}</span>
                        </vs-col>
                    </vs-row>
                    <vs-row vs-type="flex" vs-justify="space-around" class="mb-3" vs-w="12">
                        <vs-col vs-lg="4" >
                            <vs-input-number class="w-full" :label="$t('common.totalRoom')" v-model="vModel.total_room" v-validate="'required'" name="total room" ></vs-input-number>
                            <span class="error-text text-danger" v-show="errors.has('total room')">{{ errors.first('total room') }}</span>
                        </vs-col>
                        <vs-col vs-lg="4" >
                            <vs-input-number class="w-full" :label="$t('common.idSort')" v-model="vModel.id_sort"></vs-input-number>
                        </vs-col>
                    </vs-row>
                </div>
            </template>
...
export default {
    ...
    data() {
        return {
            ...
            searchFilterData: [
                ...
                { text: this.$t('common.filter.category'), value: '2' },
    ...
    beforeMount() {
        ...
        this.columnDefs = [
            ...
            { headerName: this.$t('common.table.category'), field: 'category', width: 150 },
            { headerName: this.$t('common.table.totalRoom'), field: 'total_room', width: 110, cellStyle: { textAlign: 'right' } },
            { headerName: this.$t('common.table.idSort'), field: 'id_sort', width: 90 },
