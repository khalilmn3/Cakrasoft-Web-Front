            ...
            <template #body>
                ...
                <div v-else>
                     <vs-row vs-align="center" vs-type="flex" vs-justify="flex-start" class="mb-3" vs-w="12">
                        <vs-col class="sm:w-1/6 w-full">
                            <span>{{ $t('common.code') }}</span>
                        </vs-col>
                        <vs-col class="sm:w-2/5 w-full">
                            <vs-input :maxLength="4" @input="v => { vModel.code = v.toUpperCase()}" v-bind:disabled="(modeDataValue == global.modeData.edit)" class="w-full" type="text" v-model="vModel.code" :description-text="errors.first('code') || dbErrors.code | toString" v-validate="'required'" name="code" />
                        </vs-col>
                    </vs-row>
                     <vs-row vs-align="center" vs-type="flex" vs-justify="flex-start" class="mb-3" vs-w="12">
                        <vs-col class="sm:w-1/6 w-full">
                     ...
                     <vs-row vs-align="center" vs-type="flex" vs-justify="flex-start" class="mb-3" vs-w="12">
                        ...
                        <vs-col class=" wrap-form-select sm:w-5/6 w-full">
                     ...
                     <vs-row vs-align="center" vs-type="flex" vs-justify="flex-start" class="mb-3" vs-w="12">
                        ...
                        <vs-col>
                            <vs-input-number name="id_sort" v-model="vModel.id_sort" :label="$t('common.idSort')" icon-inc="expand_less" icon-dec="expand_more"/>
                            <small class="text-danger">{{errors.first('id_sort')}}</small>
                        </vs-col>
                    </vs-row>
                </div>
            </template>
...
export default {
    ...
    beforeMount() {
        ...
        this.columnDefs = [
            ...
            { headerName: this.$t('common.table.subCategory'), field: 'name', width: 200 },
            { headerName: this.$t('common.table.idSort'), field: 'id_sort', width: 110, cellStyle: { textAlign: 'right' } },
