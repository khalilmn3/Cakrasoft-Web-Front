<template>
    <div>
        ...
        <BudgetForm ref="budgetForm" :titleForm="$t('budget.incomeBudget')" :formType="formType" @refreshData="$refs.filterHeader.onRefreshData()"/>
...
export default {
    ...
    data() {
        return {
            ...
            searchFilterData: [
                { text: this.$t('common.filter.subDepartment'), value: 0 },
                { text: this.$t('common.filter.account'), value: 1 },
                { text: this.$t('common.filter.journalAccount'), value: 2 },
    ...
    beforeMount() {
        ...
        this.columnDefs = [
            ...
            { headerName: this.$t('budget.period'), field: 'period', width: 80 },
            { headerName: this.$t('budget.subDepartment'), field: 'sub_department', width: 150 },
            { headerName: this.$t('budget.account'), field: 'Account', width: 200 },
            { headerName: this.$t('budget.journalAccount'), field: 'JournalAccount', width: 250 },
            { headerName: this.$t('budget.remark'), field: 'remark', width: 200 },
            { headerName: this.$t('budget.amount'), field: 'amount', width: 120, cellStyle: { textAlign: 'right' }, valueFormatter: formatNumber, },
            { headerName: this.$t('budget.january'), field: 'M01', width: 120, cellStyle: { textAlign: 'right' }, valueFormatter: formatNumber, },
            { headerName: this.$t('budget.february'), field: 'M02', width: 120, cellStyle: { textAlign: 'right' }, valueFormatter: formatNumber, },
            { headerName: this.$t('budget.march'), field: 'M03', width: 120, cellStyle: { textAlign: 'right' }, valueFormatter: formatNumber, },
            { headerName: this.$t('budget.april'), field: 'M04', width: 120, cellStyle: { textAlign: 'right' }, valueFormatter: formatNumber, },
            { headerName: this.$t('budget.may'), field: 'M05', width: 120, cellStyle: { textAlign: 'right' }, valueFormatter: formatNumber, },
            { headerName: this.$t('budget.june'), field: 'M06', width: 120, cellStyle: { textAlign: 'right' }, valueFormatter: formatNumber, },
            { headerName: this.$t('budget.july'), field: 'M07', width: 120, cellStyle: { textAlign: 'right' }, valueFormatter: formatNumber, },
            { headerName: this.$t('budget.august'), field: 'M08', width: 120, cellStyle: { textAlign: 'right' }, valueFormatter: formatNumber, },
            { headerName: this.$t('budget.september'), field: 'M09', width: 120, cellStyle: { textAlign: 'right' }, valueFormatter: formatNumber, },
            { headerName: this.$t('budget.october'), field: 'M10', width: 120, cellStyle: { textAlign: 'right' }, valueFormatter: formatNumber, },
            { headerName: this.$t('budget.november'), field: 'M11', width: 120, cellStyle: { textAlign: 'right' }, valueFormatter: formatNumber, },
            { headerName: this.$t('budget.december'), field: 'M12', width: 120, cellStyle: { textAlign: 'right' }, valueFormatter: formatNumber, },
    ...
    methods: {
        ...
        async getData(params) {
            try {
                ...
                const { data } = await incomeBudgetResource.list(params);
                this.rowData = data;
                this.rowData2 = [];
        ...
        async showModal(idData, modeData) {
            this.$refs.budgetForm.showModal(idData, modeData);
        },
        ...
        async deleteData(params) {
            try{
                this.$loadingIndicator(this);
                const { data } = await incomeBudgetResource.delete({id_log: params.id_log, user_id: this.global.userInfo.code});
