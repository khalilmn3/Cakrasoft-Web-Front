...
export default {
    ...
    beforeMount() {
        ...
        this.columnDefs = [
            ...
            { headerName: this.$t('apPayment.table.departureDate'), field: 'DepartureDate', width: 110, valueFormatter: formatDate, },
    ...
    methods: {
        ...
        async getData(params) {
            try {
                ...
                const { data } = await apRefundDepositResource.list(params);
                this.rowData = data;
                this.rowData2 = [];
        ...
        async getPaymentDetail(params) {
            const { data } = await apRefundDepositResource.getPaymentList({id: params.id_log});
            this.rowData2 = data;
        },
        ...
        async deleteData(params) {
            try{
                this.$loadingIndicator(this);
                const { data } = await apRefundDepositResource.deletePayment({ref_number: params.ref_number, user_id: this.global.userInfo.code});
