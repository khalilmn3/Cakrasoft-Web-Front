<template>
    <div>
        ...
        <BudgetForm ref="budgetForm" :titleForm="$t('budget.budgetStatistic')" :formType="formType" @refreshData="$refs.filterHeader.onRefreshData()"/>
...
export default {
    ...
    data() {
        return {
            ...
            searchFilterData: [
                { text: this.$t('common.filter.statisticAccount'), value: 0 },
                { text: this.$t('common.filter.remark'), value: 1 },
    ...
    beforeMount() {
        ...
        this.columnDefs = [
            ...
            { headerName: this.$t('budget.statisticAccount'), field: 'StatisticAccount', width: 200 },
    ...
    methods: {
        ...
        async getData(params) {
            try {
                ...
                const { data } = await budgetStatisticResource.list(params);
                this.rowData = data;
                this.rowData2 = [];
        ...
        async deleteData(params) {
            try{
                this.$loadingIndicator(this);
                const { data } = await budgetStatisticResource.delete({id_log: params.id_log, user_id: this.global.userInfo.code});
