...
<template>
  <div class="parentx">
    ...
    <vs-sidebar
      ...
      <!-- <div @mouseenter="mouseEnter" @click="$vs.loading({container:'#layout--main', scale:1})" @mouseleave="mouseLeave"> -->
      <div @mouseenter="mouseEnter" @mouseleave="mouseLeave">
        ...
        <!-- Menu Items -->
        <VuePerfectScrollbar ref="verticalNavMenuPs" class="scroll-area-v-nav-menu pt-2" :settings="settings" @ps-scroll-y="psSectionScroll" @scroll="psSectionScroll">
