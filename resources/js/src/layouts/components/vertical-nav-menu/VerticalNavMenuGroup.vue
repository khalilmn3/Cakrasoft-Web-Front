    ...
    @mouseout  = "mouseout">
      ...
      <div @click="clickGroup" class="group-header w-full">
        <span class="flex items-center w-full">
          ...
          <!-- Group Icon -->
          <img v-if="group.cakraIcon" class="mr-3" border="0" width="20" height="20" :src="`/images/icons/${group.icon}.png`"/>
          <feather-icon
      ...
      <ul ref="items" :style="styleItems" class="vs-sidebar-group-items">
        <li v-for="(groupItem, index) in group.submenu" :key="index">
          ...
          <v-nav-menu-item
            ...
            :icon   ="groupItem.cakraIcon ? groupItem.icon : itemIcon(groupIndex + '.' + index)"
