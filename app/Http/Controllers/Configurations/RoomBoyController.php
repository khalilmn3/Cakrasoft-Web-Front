...
use App\Configurations\Models\RoomBoy;
...
class RoomBoyController extends Controller
{
    /**
    ...
    {
        $this->mainTableName = 'cfg_init_room_boy';
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            DB::select('call insert_' . $this->mainTableName . '(?,?,?,?)', [
                $request->code, $request->name, $this->setEnum($request->is_active), $request->user_id
            ]);
