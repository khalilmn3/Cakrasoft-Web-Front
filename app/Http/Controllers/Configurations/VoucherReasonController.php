...
use App\Configurations\Models\VoucherReason;
...
class VoucherReasonController extends Controller
{
    /**
    ...
    {
        $this->mainTableName = 'cfg_init_voucher_reason';
    }
