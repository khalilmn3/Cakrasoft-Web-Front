...
class MarketingController extends Controller
{
    ...
    {
        $this->mainTableName = 'cfg_init_marketing';
    }
    ...
    {
        return [
            'code' => $isNew ? 'required|max:10|unique:' . $this->mainTableName : 'required|max:10',
