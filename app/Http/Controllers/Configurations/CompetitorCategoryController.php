...
class CompetitorCategoryController extends Controller
{
    /**
    ...
    {
        $this->mainTableName = 'cfg_init_competitor_category';
    }
    ...
    {
        $query=CompetitorCategory::find($id);
    ...
    public function delete(Request $request)
    {
        ...
        $exist = DB::table('competitor')->where('category_code',$request->code)->first();
        if (!$exist) {
    ...
    public function dataAgGrid(Request $request)
    {
        ...
        $model = CompetitorCategory::select(
