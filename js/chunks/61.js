...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data: function data() {
    return {
      ...
      searchFilterData: [{
        ...
        text: this.$t('table.continent'),
        value: '2'
      }, {
        text: this.$t('table.isoCode'),
        value: '3'
      }, {
  ...
  beforeMount: function beforeMount() {
    ...
    this.columnDefs = [{
      ...
      headerName: this.$t('table.continent'),
      field: 'continent',
      width: 200
    }, {
      headerName: this.$t('table.isoCode'),
      field: 'iso_code',
      width: 110
    }, {
                  ...
                  _c(
                    ...
                    [
                      _c(
                        ...
                        [
                          _c("span", [
                            _vm._v(_vm._s(_vm.$t("table.continent")))
                          ])
                        ]
                      ),
                      _vm._v(" "),
                        ...
                        [
                          _c("v-select", {
                            ...
                            model: {
                              ...
                              callback: function($$v) {
                                _vm.$set(_vm.vModel, "continent_code", $$v)
                              },
                          ...
                          _c(
                            ...
                            [_vm._v(_vm._s(_vm.errors.first("continent")))]
                          )
                        ],
                        1
                      )
                  ...
                  _c(
                    ...
                    [
                      _c(
                        "vs-col",
                        { staticClass: "w-full", attrs: { "vs-lg": "3" } },
                        [_c("span", [_vm._v(_vm._s(_vm.$t("table.isoCode")))])]
                      ),
                      _vm._v(" "),
                      _c(
                        "vs-col",
