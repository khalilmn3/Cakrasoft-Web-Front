...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    refreshData: function refreshData(search) {
      ...
      _utils_request_js__WEBPACK_IMPORTED_MODULE_0__["default"].get(this.routeApi + '/table/datagrid', {
        ...
        _this2.$nextTick(function () {
          Object(_utils_general_js__WEBPACK_IMPORTED_MODULE_9__["rowSelectedAfterRefresh"])(_this2, selectedNodes, 'id_log');
        });
      })["catch"](function () {
    ...
    deleteData: function deleteData(idData) {
      ...
      this.$nextTick(function () {
        ...
        Object(_utils_general_js__WEBPACK_IMPORTED_MODULE_9__["getRowIndexBefore"])(_this8);
      });
      var data = {
        code: idData.code,
  ...
  mounted: function mounted() {
    ...
    this.user_id = this.$store.state.AppActiveUser.id;
  }
});
